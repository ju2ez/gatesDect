...
for pred in predictions:
    if pred == 1:
        print ("The File %10s" %df['filename'][file_counter],"was written by Bill Gates")
    elif pred ==0:
        print("The File %10s"  %df ['filename'][file_counter], "was written by someone else than Bill Gates")
    file_counter+=1
